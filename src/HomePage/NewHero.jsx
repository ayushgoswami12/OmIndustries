    ...
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10 pt-16 md:pt-24 lg:pt-32">
        ...
        <h2 className="uppercase font-black text-4xl md:text-5xl lg:text-6xl leading-tight tracking-tight">
          <span className="text-blue-400">DIE <span className="text-[#dfbb3ad2]">CASTING MACHINE.</span></span>
        </h2>
      ...
      {/* Header */}
      <div className="header absolute top-0 left-0 w-full z-20 bg-white">
        {/* Logo or Title */}
        <motion.div
        ...
        >
          <Link to="/" className="text-white font-bold pl-4 text-3xl md:text-4xl logo-container">
        ...
        >
          <ul className="flex gap-4 md:gap-7 justify-center text-black">
